...
-------------------->
				<c:choose>
					<c:when test="${add}">
						<c:set var="action" value="/category"/>
						<c:set var="button" value="Submit"/>
					</c:when>
					<c:otherwise>
						<c:set var="action" value="/category/edit/${category.id}"/>
							...
							<div class="col-lg-12">
								<div class="element-wrapper">
									...
									<div class="element-box">
										<form:form action="${action}" method="post" modelAttribute="category" enctype="multipart/form-data">
											<h5 class="form-header">Category</h5>
											<div class="form-desc">Add and Edit product categories here</div>
											...
											<div class="form-group"><label for="">Image</label><input type="file" class="form-control" name="catimage" /></div>
