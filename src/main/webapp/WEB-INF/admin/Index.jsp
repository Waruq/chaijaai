											...
											<table class="table table-bordered table-lg table-v2 table-striped">
												...
												<tbody>
													<tr>
														...
														<td>John Mayers</td>
														<td><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/flags-icons/us.png" width="25px"></td>
													...
													<tr>
														<td class="text-center"><input class="form-control" type="checkbox"></td>
														<td>Mike Astone</td>
														<td><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/flags-icons/fr.png" width="25px"></td>
													...
													<tr>
														<td class="text-center"><input class="form-control" type="checkbox"></td>
														<td>Jessica Bloom</td>
														<td><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/flags-icons/ca.png" width="25px"></td>
								...
								<div class="chat-head">
									<div class="user-w with-status status-green">
										<div class="user-avatar-w">
											<div class="user-avatar"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar1.jpg"></div>
										</div>
										<div class="user-name">
							...
							<div class="element-box-tp">
								<div class="profile-tile">
									<div class="profile-tile-box">
										<div class="pt-avatar-w"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar1.jpg"></div>
								...
								<div class="profile-tile">
									<div class="profile-tile-box">
										<div class="pt-avatar-w"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar3.jpg"></div>
								...
								<div class="activity-boxes-w">
									<div class="activity-box-w">
										...
										<div class="activity-box">
											<div class="activity-avatar"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar1.jpg"></div>
									...
									<div class="activity-box-w">
										...
										<div class="activity-box">
											<div class="activity-avatar"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar2.jpg"></div>
											<div class="activity-info">
									...
									<div class="activity-box-w">
										...
										<div class="activity-box">
											<div class="activity-avatar"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar3.jpg"></div>
											<div class="activity-info">
									...
									<div class="activity-box-w">
										...
										<div class="activity-box">
											<div class="activity-avatar"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar4.jpg"></div>
											<div class="activity-info">
						...
						<div class="element-wrapper">
							...
							<div class="element-box-tp">
								...
								<div class="users-list-w">
									...
									<div class="user-w with-status status-green">
										<div class="user-avatar-w">
											<div class="user-avatar"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar2.jpg"></div>
										</div>
										<div class="user-name">
									...
									<div class="user-w with-status status-red">
										<div class="user-avatar-w">
											<div class="user-avatar"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar3.jpg"></div>
										</div>
										<div class="user-name">
									...
									<div class="user-w with-status status-green">
										<div class="user-avatar-w">
											<div class="user-avatar"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar4.jpg"></div>
										</div>
										<div class="user-name">
