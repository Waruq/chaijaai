...
-------------------->
			<div class="desktop-menu menu-side-w menu-activated-on-click">
				<div class="logo-w">
					<a class="logo" href="index.html"><img src="${pageContext.servletContext.contextPath}/resources/admin/img/logo.png"><span>Clean Admin</span></a>
				</div>
				<div class="menu-and-user">
					<div class="logged-user-w">
						<div class="logged-user-i">
							<div class="avatar-w"><img alt="" src="${pageContext.servletContext.contextPath}/resources/admin/img/avatar1.jpg"></div>
							<div class="logged-user-info-w">
								<div class="logged-user-name">Maria Gomez</div>
								<div class="logged-user-role">Administrator</div>
							</div>
					...
					<ul class="main-menu">
						...
						<li class="sub-menu">
							<a href="${pageContext.servletContext.contextPath}/category">
								<div class="icon-w">
									<div class="os-icon os-icon-hierarchy-structure-2"></div>
						...
						<li class="has-sub-menu">
							...
							<ul class="sub-menu">
								<li><a href="${pageContext.servletContext.contextPath}/product">Add Product</a></li>
								<li><a href="${pageContext.servletContext.contextPath}/product/search">Edit Product</a></li>
							</ul>
						</li>
				</div>
			</div>
