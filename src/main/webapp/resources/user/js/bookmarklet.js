...
whi.i18n._messages = {
  ...
  "de": {
    "bookmarklet": {
      ...
      "alert_google_images": "Du kannst Bilder nicht in der Google-_25E2_2580_258BSuche herzen._25E2_2580_258B _25C3_2596ffne bitte den Link zum Bild und herze dort._25E2_2580_258B",
  ...
  "ja": {
    ...
    "extension_specific": {
      ...
      "firefox": {
        ...
        "creator": "We Heart It_25EF_25BC_2588WHI Inc._25EF_25BC_2589"
      }
    }
  },
  "ko": {
...
whi.AlertHtml.prototype.alertData = {
    ...
    noHeart: '<div class="whi-title">' + whi.i18n.t('bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_no_heart') + "</div>",
    noPin: '<div class="whi-title">' + whi.i18n.t('bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_no_pin') + "</div>",
    weHeartIt: '<div class="whi-title">' + whi.i18n.t('bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_we_heart_it') + " <a href='../../../help.weheartit.com/customer/portal/articles/59356-hearting-images-on-whi' target='_blank'><br><br>" + whi.i18n.t('bookmarklet.need_help_q') + "</div>",
    private: '<div class="whi-title">' + whi.i18n.t('bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_private') + " <a href='../../../help.weheartit.com/customer/portal/articles/59360-hearting-from-private-pages' target='_blank'><br><br>" + whi.i18n.t('bookmarklet.need_help_q') + "</a></div>",
    googleImages: '<div class="whi-title">' + whi.i18n.t('bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.alert_google_images') + "</span>",
    ...
    noImages: '<div class="whi-title">' + whi.i18n.t('bookmarklet.hey') + '</div><div class="whi-content">' + whi.i18n.t('bookmarklet.no_image_we_can_heart') + " <a href='../../../help.weheartit.com/customer/portal/articles/59402-invalid-images' target='_blank'>" + whi.i18n.t('bookmarklet.why_is_that_q') + "</a></div>",
...
whi.ImageElement.prototype.isValid = function () {
    ...
    conditions.push({ valid: !this.image.src.match("weheartit.com"), msg: 'From weheartit' });
    conditions.push({ valid: !(this.image.src.match("facebook.com") && this.image.src.match('messaging')), msg: 'Facebook chat' });
...
whi.VideoElement.prototype.thumbnail = function (callback) {
    ...
    if (this.media().match(/vimeo\.com/)) {
        ...
        whi.bookmarklet.jsonp(this.document, "../../../vimeo.com/api/v2/video/" + videoId + ".json", "whi.bookmarklet.vimeo_" + videoId + "_cb");
        ...
        callback("../../../img.youtube.com/vi/" + videoId + "/mqdefault.jpg");
    }
};
            ...
            return {
                image: {
                    all: function () {
                        ...
                        if (doc.location.host === "www.tumblr.com" && doc.location.pathname === "../../default.htm") {
